/**
 * Regent v1.0.0 - Regent - The landing page king.
 * @link 
...
;(function () {
    ...
    $("#say").typed({
		strings: ["Hello...", "Hola...", "Bonjour...", "Salve...", "Hallo...", "Kire...", "नमस्ते..."],
		typeSpeed: 100,
        backSpeed: 50,
        backDelay: 1000,
        loop: true
    ...
    /*==============================================
     Portfolio grid init
     ===============================================*/
    var $regentPortfolio = $('.js-Portfolio');

    $regentPortfolio = $('.js-Portfolio').isotope({
        itemSelector: '.portfolio-item',
        filter: '*'
    });

    if ($.fn.imagesLoaded) {
        $regentPortfolio.imagesLoaded().progress(function () {
            $regentPortfolio.isotope('layout');
        });
    }
    ...
    $('.js-PortfolioFilter').on('click focus', 'a', function (e) {
        ...
        $regentPortfolio.isotope({filter: $this.data('filter')});
    });
