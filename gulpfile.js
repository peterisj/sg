...
var banner = ['/**',
              ' * Regent v<%= pkg.version %> - <%= pkg.description %>',
              ' * @link <%= pkg.homepage %>',
...
var pluginsJS  = ['assets/vendor/jquery/jquery-1.12.0.min.js',
                  ...
                  'assets/vendor/typed/typed.min.js'];
...
gulp.task('inject', function(){
    ...
    var appStream = gulp.src(['assets/js/'+pkg.name+'.js'], {read: false});
    gulp.src('*.html')
...
gulp.task('injectPro', function(){
    ...
    var source = gulp.src(['assets/css/plugins.css', 'assets/js/plugins.js', 'assets/js/'+pkg.name+'.min.js'], {read: false});
    gulp.src('*.html')
